    ...
    return(
        ...
        <div className="panel-body">
          <div className="row">
            ...
            <li className="list-group-item"><strong>Username:&emsp; </strong>{this.props.userData.login}</li>
            <li className="list-group-item"><strong>Location:&emsp;</strong>{this.props.userData.location}</li>
            <li className="list-group-item"><strong>Email:&emsp;</strong>{this.props.userData.email}</li>
            </ul>
            </div>   
            </div>
            <br/>
